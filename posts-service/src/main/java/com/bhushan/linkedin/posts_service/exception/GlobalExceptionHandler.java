package com.bhushan.linkedin.posts_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleResourceNotFoundExcpetion(ResourceNotFoundException exception){
